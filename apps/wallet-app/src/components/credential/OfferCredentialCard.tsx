...
export const OfferCredentialCard = ({ display, credentialIssuer }: Props) => {
  return (
    <div className="border px-5 py-5 rounded-xl">
      ...
      <div className="flex px-5 mt-5 justify-between">
        <button className="inline-flex justify-center rounded-md border border-transparent bg-white px-4 py-2 text-sm font-medium text-red-700 hover:bg-gray-100 focus:outline-none focus-visible:ring-2 focus-visible:ring-red-500 focus-visible:ring-offset-2">
          Reject
        </button>
